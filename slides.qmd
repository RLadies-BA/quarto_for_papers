...
You can add a label to a section heading in curly braces after the heading, e.g `## Data & Methods {#sec-data-methods}` and the you can then reference this section in the text by adding the text and the @ reference like `Data and methods are discussed in @sec-data-methods.`
<br>
:::
