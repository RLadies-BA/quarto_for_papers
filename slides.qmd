...
format: 
  revealjs:
    ...
    incremental: true   
    slide-number: true
    footer: "https://from-code-to-paper-with-quarto.netlify.app/"
    chalkboard: 
      buttons: true
editor: 
  markdown: 
...
If you just want to create one Quarto document for your journal you can find some templates in the gihgub repo.
...
## How doed the journal template file looks like
...
## Cross Reference Tip: Use the visual mode to add cross reference
